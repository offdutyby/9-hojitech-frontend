    ...
    constructor(props){
      ...
      this.state={
        mockData:[
            {
              id:1,
              thumnailImage:"https://www.logitech.com/assets/65776/73/mx-master-3.png",
              productName:"MX MASTER 3",
              hoverColor:'red',
              thumbnailDescription:"상품 설명"
            },
            {
              id:2,
              thumnailImage:"https://www.logitech.com/assets/65107/13/mx-anywhere-2s.png",
            ...
            {
              id:3,
              thumnailImage:"https://www.logitech.com/assets/65685/15/logitech-pebble-m350.png",
            ...
            {
              id:4,
              thumnailImage:"https://www.logitech.com/assets/65122/13/wireless-mouse-m585-multi-device.png",
            ...
            {
              id:5,
              thumnailImage:"https://i.pinimg.com/474x/71/84/b9/7184b9c6f6adc1530eaa532abbbe7a4e.jpg",
              productName:"sample",
              hoverColor:'powderblue',
              thumbnailDescription:"상품 설명"
            },
            {
              id:6,
              thumnailImage:"https://i.pinimg.com/564x/15/e0/6a/15e06af473ec98a9870d3691fcb4277b.jpg",
              productName:"sample",
              hoverColor:'grey',
              thumbnailDescription:"상품 설명"
            },
...
render(){
    const {visible, filterVisible, mockData, collectionIcon} = this.state
        ...
        <div className="ProductList"> 
            ...
            <div className="mainArticle">
              ...
              <div className="productListMainContainer">
                <div className={`filterSidebar ${filterVisible ? "hideFilter": "showFilter"}`}>
